...
$$
\mathbf{W}^{l} = \left[\begin{array}{cccc}{w_{11}^l} & {w_{12}^l} & {\cdots} \\ {w_{21}^l} & {w_{22}^l} & {\cdots} & \\ {\vdots} & {\vdots} & {\ddots}\end{array}\right], \mathbf{a}^l = \left[\begin{array}{cccc}{a_1^l} \\ {a_2^l} \\ {\vdots}\end{array}\right], \mathbf{b}^l = \left[\begin{array}{cccc}{b_1^l} \\ {b_2^l} \\ {\vdots}\end{array}\right]
$$
$w_{ij}^l$: neuron $j$ (layer $l-1$) to neuron $i$ ( layer $l$); $\mathbf{a}^l$: layer $l$ vector
$$
\mathbf{a}^l =\operatorname{Relu}(\mathbf{W}^l\mathbf{a}^{l-1} + \mathbf{b}^l)
$$

$$
\mathbf{X}^l = \operatorname{Relu}(\mathbf{X}^{l-1}\mathbf{W}^l +\mathbf{b}^l)
$$

$\mathbf{X}^l\in \mathbb{R}^{b\times N^{l-1}},\mathbf{W}^l\in\mathbb{R}^{N^{l-1}\times N^{l}},\mathbf{b}^l\in\mathbb{R}^{N^l}$
